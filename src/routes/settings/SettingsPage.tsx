...
import { Check, CircleHelp, CloudOff, Keyboard, Link2, LockKeyhole, Mail, MessageCircle, Monitor, Moon, Phone, ShieldCheck, Sun, type LucideIcon } from "lucide-react";
...
function SettingsContent({ email }: { email: string }) {
  ...
  const section = SETTINGS_SECTIONS.find((item) => item.id === searchParams.get("section"))?.id ?? "appearance";
  ...
  return (
    <div className="mx-auto max-w-6xl space-y-7">
      ...
      <div className={cn("grid min-w-0 gap-7 xl:gap-10", !settings.contextPanelOpen && "xl:grid-cols-4")}>
